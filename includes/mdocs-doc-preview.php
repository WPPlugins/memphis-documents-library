...
function mdocs_load_preview_iframe($file) {
	if(get_option('mdocs-preview-type') == 'google') {
		...
		?>
		<iframe id="mdocs-box-view-iframe" src="//docs.google.com/gview?url=<?php echo $link; ?>&embedded=true&mdocs-session=<?php echo md5(microtime()); ?>" style="border: none; width: 100%;" seamless fullscreen></iframe>
		<script>
